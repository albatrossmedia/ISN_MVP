...
import { Menu, Search, User, Sun, Moon, LogOut, Settings } from 'lucide-react';
import { useTheme } from '../../contexts/ThemeContext';
import { useAuth } from '../../contexts/AuthContext';
import { NotificationCenter } from '../onboarding/NotificationCenter';
            ...
            {showUserMenu && (
              <div className="absolute right-0 mt-2 w-48 bg-black/90 backdrop-blur-xl rounded-xl shadow-2xl border border-white/10 py-1">
                ...
                <button
                  ...
                  className="w-full px-4 py-2 text-left text-sm text-red-400 hover:text-red-300 hover:bg-white/5 flex items-center space-x-2 transition-all"
                >
